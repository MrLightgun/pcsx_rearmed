...
struct retro_core_option_definition option_defs_us[] = {
   ...
   {
      "pcsx_rearmed_offscreen",
      "Guncon Offscreen Reload",
      "When using Guncon mode, shots at the edge of the screen will action Guncon Aux A.",
      {
         { "disabled", NULL },
         { "enabled",  NULL },
         { NULL, NULL },
   ...
   {
      "pcsx_rearmed_offscreenreloadsize",
      "Guncon Offscreen Reload Size",
      "How much of the side of the screen counts as an offscreen reload when shot in Guncon mode.",
      {
         { "1", NULL },
         { "2", NULL },
         { "3", NULL },
